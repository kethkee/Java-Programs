...
public class calc implements ActionListener {
 ...
 b4 = new JButton("+"); b5 = new JButton("4"); b6 = new JButton("5");
 b7 = new JButton("6"); b8 = new JButton("-"); b9 = new JButton("7");
 b10 = new JButton("8"); b11 = new JButton("9"); b12 = new JButton("*");
 b13 = new JButton("/"); b14 = new JButton("0"); b15 = new JButton("=");
 b16 = new JButton("C");
 // Set button bounds
...
secondOperand = Integer.parseInt(t1.getText());
 switch (i) {
 case 1: res = n + secondOperand; break;
 case 2: res = n - secondOperand; break;
 case 3: res = n * secondOperand; break;
 case 4:
 if (secondOperand != 0) {
 res = n / secondOperand;
 } else {
